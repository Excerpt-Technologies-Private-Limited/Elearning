      ...
      <footer className="footer -type-1 bg-dark-1 -green-links">
        <div className="container">
          ...
          {/* <div className="footer-columns">
           ...
           <div className="row justify-between items-center y-gap-20 mb-3">
              <div className="col-auto">
                <div className="d-flex items-center h-100 text-white">
                  Development | Business | Finance &amp; Accounting | IT &amp; Software | Office Productivity | Design |
                </div>
              </div>
              <div className="col-auto">
          ...
          <div className="py-30 border-top-light-15">
            <div className="row justify-between items-center y-gap-20">
              <div className="col-auto">
                <div className="d-flex items-center h-100 text-white">
                  © 2025 Nipuna Technologies. All Right Reserved.
                </div>
              </div>
              <div className="col-auto">
                <div className="d-flex x-gap-20 y-gap-20 items-center flex-wrap">
