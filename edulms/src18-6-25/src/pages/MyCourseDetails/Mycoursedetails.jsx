            ...
            <div className="row mb-3">
              <div className="col-12">
                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 className="mb-sm-0 font-size-18">Live Class Details</h4>
                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    <p className="text-muted">
                      Total: {totalVideos} | Completed: {completedVideos} | Progress: {completionPercent}%
                    </p>
                  </div>
                  <div className="card-body">
                    {selectedVideo ? (
                      ...
                      <p>Select a video to watch the lesson.</p>
                    )}
                  </div>
                </div>
              </div>
