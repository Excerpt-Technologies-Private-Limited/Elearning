...
//       const ordersWithId = ordersArray.filter(order =>
//         order.orderId && order.orderId.toString().trim() !== ''
//       );
...
//     const totalSales = ordersData.reduce((sum, order) => sum + (order.amount || 0), 0);
...
//         (filters.paymentMethod === '' || order.paymentMethod?.toLowerCase().includes(filters.paymentMethod.toLowerCase())) &&
//         (filters.searchTerm === '' ||
//           order.orderId?.toLowerCase().includes(filters.searchTerm.toLowerCase()) ||
//           order.paymentId?.toLowerCase().includes(filters.searchTerm.toLowerCase()) ||
//           order.shipping?.email?.toLowerCase().includes(filters.searchTerm.toLowerCase()) ||
//           order.shipping?.firstName?.toLowerCase().includes(filters.searchTerm.toLowerCase()) ||
//           order.shipping?.lastName?.toLowerCase().includes(filters.searchTerm.toLowerCase())
//         ) &&
...
//                         <h4 className="mb-2">{formatCurrency(stats.totalSales)}</h4>
//                       </div>
...
//                         <h4 className="mb-2">{stats.totalOrders}</h4>
//                       </div>
//                       <div className="avatar-sm">
...
//                     <div className="d-flex">
//                       <div className="flex-1">
//                         <p className="text-truncate font-size-14 mb-2">Average Order Value</p>
//                         <h4 className="mb-2">{formatCurrency(stats.averageOrderValue)}</h4>
//                       </div>
//                       <div className="avatar-sm">
//                         <span className="avatar-title bg-light text-info rounded-3">
//                           <i className="bx bx-bar-chart-alt-2 font-size-24"></i>
//                         </span>
//                       </div>
//                     </div>
//                   </div>
...
//                     <div className="d-flex">
//                       <div className="flex-1">
//                         <p className="text-truncate font-size-14 mb-2">Paid Orders</p>
//                         <h4 className="mb-2">{stats.paidOrders}</h4>
//                       </div>
//                       <div className="avatar-sm">
...
//                                           <small className="fw-medium">{product.title}</small>
//                                           <br />
//                                           <small className="text-muted">
...
//                                         <i className={`bx ${order.status === 'paid' ? 'bx-check-circle' : 'bx-time'} me-1`}></i>
//                                         {order.status}
//                                       </span>
//                                     </td>
//                                     <td>
...
//                                 Showing {indexOfFirstOrder + 1} to {Math.min(indexOfLastOrder, Array.isArray(filteredOrders) ? filteredOrders.length : 0)} of {Array.isArray(filteredOrders) ? filteredOrders.length : 0} entries
//                               </div>
//                             </div>
