      ...
      <header className="header -type-1 ">
        <div className="header__container">
          <div className="row justify-between items-center">
            <div className="col-auto">
              <div className="header-left">
                ...
                <div className="header__explore text-green-1 ml-60 xl:ml-30 xl:d-none">
                  ...
                  <div
                    className={`explore-content py-25 rounded-8 bg-white toggle-element js-explore-toggle ${exploreVisible ? "-is-el-visible" : ""
                      }`}
                  >
                ...
                <div className="menu js-navList">
                  <ul className="menu__nav text-white -is-active">
                    ...
                    <li class="menu-item-has-children -has-mega-menu">
                      <Link data-barba="true" class="" to="/AllCourse">
                              ...
                              {courseData.slice(0,6).map((course, index) => (
                                <ul class="mega__list">
                                  <li class="inActiveMegaMenu">
                                    <Link data-barba="true" className="" to="/AllCourse">
                                      {course.courseName}
                                    </Link>
                                  </li>
                                </ul>
            ...
            <div
              className={`header-menu js-mobile-menu-toggle isVisible ?  ${isVisible ? "-is-el-visible" : ""
                }`}
            >
              <div className="header-menu__content">
                <div className="mobile-bg js-mobile-bg"></div>
                <div className="d-none xl:d-flex items-center px-20 py-20 border-bottom-light">
                  ...
                  <Link
                    className="text-dark-1 ml-30 inActiveMenu "
                    to="/signup"
                  >
                    Sign Up
                  </Link> */}
                  ...
                  <button
                    ...
                    className="text-dark-1 inActiveMenu "
                  >
                    Log in
                  </button>
                  <LoginModal
                  ...
                  <div className="relative ml-30 xl:ml-20">
                    <Link to="/CourseCart">
                      ...
                      >
                        ...
                        {cartlength > 0 && (
                          <div className="cartProductCount">{cartlength} </div>)}
                      </button>
                    </Link>
                  </div>
