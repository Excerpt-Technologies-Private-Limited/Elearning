...
const Category1 = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (editingId) {
      await axios.put(`http://localhost:8080/api/categories/${editingId}`, { categoryName });
    } else {
      await axios.post('http://localhost:8080/api/categories', { categoryName });
    }
    setCategoryName('');
    setEditingId(null);
    fetchCategories();
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered border-success mb-0">
                    ...
                    <tbody>
                       {categories.map((cat) => (<tr key={cat._id}>
