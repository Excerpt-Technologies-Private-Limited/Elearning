...
console.log("filtered",selectedCategories) ;
    ...
    if (!selectedCategories.includes('all') && selectedCategories.length > 0) {
      filtered = filtered.filter(course => {
        ...
        if (!Array.isArray(course.categoryIds) || course.categoryIds.length === 0) {
          return false; // exclude if no categories
        }
    
        // Convert course categoryIds to strings for safe comparison
        const courseCategoryIdStrs = course.categoryIds.map(id => id._id.toString());
                            ...
                            >
                              ...
                              >
                                <span className="js-dropdown-title">
                                  {sortBy === 'default' ? 'Default' :
                                   ...
                                   sortBy === 'name_desc' ? 'Name (Z-A)' : 'Default'}
                                </span>
                                <i className="icon text-9 ml-40 icon-chevron-down"></i>
                              </div>
                              <div
                              ...
                              >
                                <div className="text-14 y-gap-15 js-dropdown-list">
                                  ...
                                  <div>
                                    <span 
                                      className={`d-block js-dropdown-link cursor ${sortBy === 'name_asc' ? 'activeMenu' : ''}`}
                                  ...
                                  <div>
                                    <span 
                                      className={`d-block js-dropdown-link cursor ${sortBy === 'name_desc' ? 'activeMenu' : ''}`}
                      ...
                      <div className="relative">
                        <div className="coursesCard__image overflow-hidden rounded-8">
                          <img
                            ...
                            data-nimg="1"
                            className="w-1/1"
                            src={course.courseImages?.[0] ? `/${course.courseImages[0]}` : '/placeholder-course-image.jpg'}
                            style={{ color: "transparent" }}
                            onError={(e) => {
                      ...
                      <div className="h-100 pt-15">
                        ...
                        <div className="d-flex x-gap-10 items-center pt-10">
                          <div className="d-flex items-center">
                            ...
                            <div className="text-14 lh-1">{course.lessons || 6} lesson{course.lessons !== 1 ? 's' : ''}</div>
                          </div>
                          <div className="d-flex items-center">
                            <div className="mr-8">
                              <img
                            ...
                            <div className="text-14 lh-1">{course.duration || '22h 0m'}</div>
                          </div>
                          <div className="d-flex items-center">
                            <div className="mr-8">
                              <img
                            ...
                            <div className="text-14 lh-1">{course.level || 'Beginner'}</div>
                          </div>
                        </div>
                        <div className="coursesCard-footer">
                          <div className="coursesCard-footer__author">
                            <img
                              ...
                              decoding="async"
                              data-nimg="1"
                              src={course.instructorImage || "https://educrat-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fgeneral%2Favatar-1.png&w=64&q=75"}
                              style={{ color: "transparent" }}
                            />
                            <div>{course.instructorName || 'Jane Cooper'}</div>
                          </div>
                          <div className="coursesCard-footer__price">
                            <div>₹{course.price === 0 || course.price === '0' || !course.price ? 'Free' : course.price}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      {Array.from({ length: Math.min(totalPages, 5) }, (_, index) => {
                        ...
                        return (
                          <div key={pageNumber} className="pagination__count">
                            <button 
                              className={`${currentPage === pageNumber ? "-count-is-active" : ""}`} 
